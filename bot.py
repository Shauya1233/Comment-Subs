...
YOUR_CHANNEL_ID = "UCsQ29vcqdlCzRBvk2m2BOcQ"  # Your channel - comments won't be hidden
VIDEO_ID = "0xsPqbq7Fkg"  # Your new video
...
def moderate_comments():
    """Check and hide non-verified comments (except from owner)"""
    try:
